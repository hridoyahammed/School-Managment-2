...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12">
            {!! Form::open(array('route'=>['attendence.update',$data->id],'method'=>'PUT','class'=>'form-horizontal', 'files'=>true)) !!}

            <div class="row col-md-8" style="font-weight: 600;">
                {{ Form::label('dmy', 'Date', array('class'=>'col-md-4 form-group'))}}
                {{ Form::date('dmy', $data->dmy, array('class'=>'col-md-8 form-control form-group', 'placeholder'=>'Date*'))}}
           ...
           <p>{{ $errors->first('dmy') }}</p>
            ...
            <div class="row col-md-8" style="font-weight: 600;">
                ...
                {{ Form::text('student_id',  $data->student_id, array('class'=>'col-md-8 form-control form-group', 'placeholder'=>'Student Id*'))}}
                <div class="col-md-4"></div>
                <div class="col-md-8" style="color: #c7254e; padding: -5px 5px;">
           ...
           <p>{{ $errors->first('student_id') }}</p>
            ...
            <div class="row col-md-8" style="font-weight: 600;">
                ...
                {{ Form::select('class', ['Null'=>'Select Class*','Six'=>'Six', 'Seven'=>'Seven','Eight'=>'Eight','Nine'=>'Nine','Ten'=>'Ten'],$data->class,array('class'=>'col-md-8'))}}

            </div>
            <div class="row col-md-8" style="font-weight: 600;">
                {{ Form::label('roll', 'Roll', array('class'=>'col-md-4 form-group'))}}
                {{ Form::number('roll', $data->roll, array('class'=>'col-md-8 form-control form-group', 'placeholder'=>'Roll*'))}}
                <div class="col-md-4"></div>
                <div class="col-md-8" style="color: #c7254e; padding: -5px 5px;">
                    @if($errors->has('roll'))
                        <span class="help-block" style="display:block">
    ...
    <div class="row col-md-8" style="font-weight: 600;">
        ...
        {{ Form::text('section', $data->section, array('class'=>'col-md-8 form-control form-group', 'placeholder'=>'Section*'))}}
    ...
    <div class="row col-md-8" style="font-weight: 600;">
        ...
        {{ Form::text('in_time', $data->in_time, array('class'=>'col-md-8 form-control form-group', 'placeholder'=>'In Time*'))}}
    ...
    <div class="row col-md-8" style="font-weight: 600;">
        ...
        {{ Form::text('out_time', $data->out_time, array('class'=>'col-md-8 form-control form-group', 'placeholder'=>'Out Time*'))}}
    ...
    <div class="row col-md-8" style="font-weight: 600;">
        ...
        {{ Form::select('status', ['Null'=>'Select Status*','Present'=>'Present', 'Absent'=>'Absent'],$data->status,array('class'=>'form-group form-control col-md-8'))}}
