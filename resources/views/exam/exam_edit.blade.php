...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="row col-md-8" style="font-weight: 600;">
                ...
                {{ Form::text('exam_name', $data->exam_name, array('class'=>'col-md-8 form-control form-group', 'placeholder'=>'Exam Name*'))}}
           ...
           <p>{{ $errors->first('exam_name') }}</p>
            ...
            <div class="row col-md-8" style="font-weight: 600;">
                ...
                {{ Form::date('held_on', $data->held_on, array('class'=>'col-md-8 form-control form-group', 'placeholder'=>'Held On*'))}}
                <div class="col-md-4"></div>
                <div class="col-md-8" style="color: #c7254e; padding: -5px 5px;">
           ...
           <p>{{ $errors->first('held_on') }}</p>
            ...
            <div class="row col-md-8" style="font-weight: 600;">
                ...
                {{ Form::number('year',$data->year, array('class'=>'col-md-8 form-control form-group', 'placeholder'=>'Year*'))}}
                <div class="col-md-4"></div>
                <div class="col-md-8" style="color: #c7254e; padding: -5px 5px;">
                    @if($errors->has('year'))
                        <span class="help-block" style="display:block">
    ...
    <div class="row">
        <div class="h-60"></div>
        <div class="col-md-6">
            <button style="width: 100px; border-radius:0px;" type="submit" class="btn button"><b>Save</b></button>
        </div>
